...
#Simple Perceptron
#===============================================================================
# My main neural-network functions are:
# 1. neuralnetwork 
...
#calculates the deltas for a batch (using backprop) and then updates the weights and bias matricies
...
#The SGD function splits the training-data into random mini-batches and sends them off to the update_mini_batch function.
...
#The neuralnetwork function's main job is to initialise the weight and bias matricies for a given list of sizes
